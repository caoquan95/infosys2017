...
CREATE VIEW emp_finance_last_name AS
  SELECT last_name
  FROM
    employees
...
WHERE employees.last_name IN (
  SELECT last_name
  FROM emp_finance_last_name
);
	\end{lstlisting}
	\begin{center}
\includegraphics[width=0.75\columnwidth]{11} %
\includegraphics[width=0.75\columnwidth]{12} %
\includegraphics[width=0.75\columnwidth]{13} %
\end{center}
...
\begin{lstlisting}[language=SQL]
CREATE VIEW last_promo AS
  SELECT MAX(from_date) AS max_date
  FROM dept_manager
    JOIN departments ON dept_manager.dept_no = departments.dept_no
...
WHERE dept_emp.dept_no = (
  ...
  WHERE dept_name = 'Production'
	...
	\end{lstlisting}
	\begin{center}
\includegraphics[width=0.75\columnwidth]{21} %
\includegraphics[width=0.75\columnwidth]{22} %
\includegraphics[width=0.75\columnwidth]{23} %
\end{center}
...
FROM dept_salary
GROUP BY dept_salary.dept_no
ORDER BY avg_salary DESC;
	\end{lstlisting}
	\begin{center}
\includegraphics[width=0.75\columnwidth]{31} %
\includegraphics[width=0.75\columnwidth]{32} %
\includegraphics[width=0.75\columnwidth]{33} %
\end{center}


\item Find the average salary for each type of Engineer, from highest to lowest.
\begin{lstlisting}[language=SQL]
CREATE VIEW salary_engineer AS
  SELECT
    title,
    salary
  FROM salaries
...
SELECT
  title,
  AVG(salary) AS avg_salary
FROM salary_engineer
GROUP BY title
ORDER BY avg_salary DESC;
	\end{lstlisting}
	\begin{center}
\includegraphics[width=0.75\columnwidth]{41} %
\includegraphics[width=0.75\columnwidth]{42} %
\includegraphics[width=0.75\columnwidth]{43} %
\end{center}
