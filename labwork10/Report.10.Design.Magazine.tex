...
\newcommand{\hmwkTitle}{Report \#10} % Assignment title
...
\item Author
\begin{center}
\includegraphics[width=0.75\textwidth]{concept.png}
\end{center}
\end{itemize}

\item Determine Attributes of each concept
\begin{center}
\includegraphics[width=0.75\textwidth]{attributes.png}
\end{center}


\item Determine links (relationships) between them
\begin{center}
\includegraphics[width=0.75\textwidth]{relations.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{types.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{keys.png}
\end{center}
