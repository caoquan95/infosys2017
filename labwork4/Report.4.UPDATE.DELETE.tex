...
\begin{enumerate}
	\item Insert department Research and Development
...
\item Insert department Marketing and Sales
	\begin{lstlisting}[language=SQL]
...
\item Move all employees from the old departments to the new departments
	\begin{lstlisting}[language=SQL]
...
\item Move all managers from the old departments to the new departments
	\begin{lstlisting}[language=SQL]
